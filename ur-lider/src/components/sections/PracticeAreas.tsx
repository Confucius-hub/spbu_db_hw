...
export function PracticeAreas() {
  return (
    <Section tone="paper" id="practices">
      <SectionHeading
        eyebrow="Практики"
        title="Решаем правовые задачи бизнеса и частных клиентов"
        subtitle="Шесть профильных направлений. В каждом — выделенная команда с глубокой экспертизой и измеримым результатом."
      />
