...
/** Фирменная обложка статьи на основе градиента — без внешних изображений. */
export function ArticleCover({
  ...
  return (
    ...
    >
      <div
        className={cn("absolute inset-0 opacity-60", s.pattern === "grid" ? "bg-grid" : "bg-dots opacity-20")}
        aria-hidden
      />
      <div
      ...
      <Icon
        ...
        strokeWidth={1.25}
      />
      <span className="absolute left-4 top-4 inline-flex items-center gap-1.5 rounded-full bg-white/10 px-3 py-1 text-xs font-semibold text-gold-200 ring-1 ring-white/15 backdrop-blur-sm">
