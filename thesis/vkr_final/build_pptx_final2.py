...
# ── Реальный снимок Кольского залива — ПОЛНАЯ ШИРИНА внизу ─────────────
txt(s, Inches(0.7), Inches(4.42), Inches(11.9), Inches(0.32),
    [[("Кольский залив, Sentinel-1 2024 — временно́й ряд детектирования разлива мазута 11.08.2024 (сцены: до · разлив · после)",
       11, True, GRAY)]])
add_image_fit(s, FIG + "fig_kola_real.jpg",
              Inches(0.45), Inches(4.78),
              Inches(12.45), Inches(2.5))
