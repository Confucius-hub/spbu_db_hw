...
txt(s, Inches(0.7), Inches(2.45), Inches(12.0), Inches(2.0),
    [[("Автоматическое детектирование нефтяных разливов", 33, True, WHITE)],
     [("в акваториях арктических портов по данным", 33, True, WHITE)],
     [("спутниковой радиолокационной съёмки", 33, True, WHITE)]],
    line=1.06, space_after=2)
# три колонки
cols = [
    ("Байханов\nВладислав Камолович",
...
bullets(s, Inches(0.7), Inches(1.7), Inches(5.9), Inches(3.2),
        [("> 700 тыс. т/год", " углеводородов попадает в Мировой океан; доля Арктики растёт из-за СМП и шельфа"),
         ("В 5–10 раз медленнее", " разлагается нефть в холодных водах → долговременное загрязнение"),
         ("> 80 % времени", " — облачность и полярная ночь: оптические спутники бесполезны"),
         ("Sentinel-1 (SAR)", " — всепогодный круглосуточный мониторинг")],
        size=15, gap=11)
# красная плашка-проблема
cardp = card(s, Inches(0.7), Inches(5.35), Inches(5.9), Inches(1.4),
             bg=RGBColor(0xFD, 0xF0, 0xEE), border=RGBColor(0xF0, 0xC8, 0xC0),
             accent=OIL)
txt(s, Inches(0.95), Inches(5.5), Inches(5.5), Inches(1.1),
    [[("Главная проблема: ложные цели", 15, True, OIL)],
...
pre = [
    ...
    ("Перевод в дБ", "логарифмическая шкала [−35; 0] дБ"),
]
y = Inches(1.9)
